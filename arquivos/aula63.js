...
const gerenciarExibicaoCarros=()=>{
    ...
    a_carros.forEach((c)=>{
        ...
        btn.addEventListener("click",(evt)=>{
            ...
            gerenciarExibicaoCarros() // Ele chama o método dentro dele mesmo! aí não sei.
        ...
        div.innerHTML+=`Bilndagem: ${c.blindagem}<br/>`
...
class Militar extends Carro{ // Classe Filho
    constructor(nome,portas,blindagem,municao){
        ...
        super(nome,portas) // chamar o construtor da classe Pai
